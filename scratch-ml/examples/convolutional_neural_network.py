...
from scratch.utils import train_test_split, to_categorical, normalize
from scratch.utils import get_random_subsets, shuffle_data, Plot
from scratch.utils.data_operation import accuracy_score
