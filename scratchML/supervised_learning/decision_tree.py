...
from scratchML.utils import divide_on_feature, train_test_split, standardize, mean_squared_error
from scratchML.utils import calculate_entropy, accuracy_score, calculate_variance
