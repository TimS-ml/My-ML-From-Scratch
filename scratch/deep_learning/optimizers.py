import numpy as np
from scratch.utils import make_diagonal, normalize
...
class Adadelta():
    ...
    def update(self, w, grad_wrt_w):
        ...
        self.E_grad = self.rho * self.E_grad + (1 - self.rho) * np.power(
            grad_wrt_w, 2)
...
class RMSprop():
    ...
    def update(self, w, grad_wrt_w):
        ...
        return w - self.learning_rate * grad_wrt_w / np.sqrt(self.Eg +
                                                             self.eps)
