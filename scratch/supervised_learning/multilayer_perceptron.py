...
from scratch.utils import train_test_split, to_categorical, normalize, accuracy_score, Plot
from scratch.deep_learning.activation_functions import Sigmoid, Softmax
